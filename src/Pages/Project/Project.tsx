...
export const Project: React.SFC<any>= (props) => {
    ...
    // const [isLoadingProjectInformation, setIsLoadingProjectInformation] = useState(false);
    // const [isLoadingCheckpoints, setIsLoadingCheckpoint] = useState(false);
    useEffect(() => {
        useCaseId();
...
// extends React.Component<IProjectPresentationProps, IProjectPresentationState> {
